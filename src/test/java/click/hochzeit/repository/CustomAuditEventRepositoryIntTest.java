...
import click.hochzeit.config.audit.AuditEventConverter;
import click.hochzeit.domain.PersistentAuditEvent;
...
import static click.hochzeit.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
