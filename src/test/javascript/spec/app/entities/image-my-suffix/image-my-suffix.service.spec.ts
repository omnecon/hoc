...
describe('Service Tests', () => {
    ...
    describe('ImageMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ImageMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ImageMySuffix', () => {

                let entity: ImageMySuffix;
                service.find(123).subscribe((_entity: ImageMySuffix) => {
                    entity = _entity;
                });
