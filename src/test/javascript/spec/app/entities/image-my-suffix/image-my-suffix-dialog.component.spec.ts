...
import { ImageMySuffixDialogComponent } from '../../../../../../main/webapp/app/entities/image-my-suffix/image-my-suffix-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('ImageMySuffix Management Dialog Component', () => {
        let comp: ImageMySuffixDialogComponent;
        let fixture: ComponentFixture<ImageMySuffixDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ImageMySuffixDialogComponent],
                providers: [
                    ImageMySuffixService
                ]
            })
            .overrideTemplate(ImageMySuffixDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(ImageMySuffixDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new ImageMySuffix(123);
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new ImageMySuffix();
