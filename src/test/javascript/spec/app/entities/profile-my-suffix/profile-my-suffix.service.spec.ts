...
describe('Service Tests', () => {
    ...
    describe('ProfileMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProfileMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/profiles/' + 123);
            });
            it('should return ProfileMySuffix', () => {

                let entity: ProfileMySuffix;
                service.find(123).subscribe((_entity: ProfileMySuffix) => {
                    entity = _entity;
                });
