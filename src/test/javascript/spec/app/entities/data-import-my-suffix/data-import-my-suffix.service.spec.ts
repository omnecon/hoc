...
describe('Service Tests', () => {
    ...
    describe('DataImportMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DataImportMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/data-imports/' + 123);
            });
            it('should return DataImportMySuffix', () => {

                let entity: DataImportMySuffix;
                service.find(123).subscribe((_entity: DataImportMySuffix) => {
                    entity = _entity;
                });
