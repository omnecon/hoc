...
describe('Service Tests', () => {
    ...
    describe('StatisticMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(StatisticMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/statistics/' + 123);
            });
            it('should return StatisticMySuffix', () => {

                let entity: StatisticMySuffix;
                service.find(123).subscribe((_entity: StatisticMySuffix) => {
                    entity = _entity;
                });
