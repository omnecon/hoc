...
describe('Service Tests', () => {
    ...
    describe('FeatureMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FeatureMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/features/' + 123);
            });
            it('should return FeatureMySuffix', () => {

                let entity: FeatureMySuffix;
                service.find(123).subscribe((_entity: FeatureMySuffix) => {
                    entity = _entity;
                });
