...
describe('Service Tests', () => {
    ...
    describe('BannerMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BannerMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/banners/' + 123);
            });
            it('should return BannerMySuffix', () => {

                let entity: BannerMySuffix;
                service.find(123).subscribe((_entity: BannerMySuffix) => {
                    entity = _entity;
                });
