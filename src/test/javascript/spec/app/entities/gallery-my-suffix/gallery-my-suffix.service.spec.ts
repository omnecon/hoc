...
describe('Service Tests', () => {
    ...
    describe('GalleryMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GalleryMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/galleries/' + 123);
            });
            it('should return GalleryMySuffix', () => {

                let entity: GalleryMySuffix;
                service.find(123).subscribe((_entity: GalleryMySuffix) => {
                    entity = _entity;
                });
