...
import { GalleryMySuffixDialogComponent } from '../../../../../../main/webapp/app/entities/gallery-my-suffix/gallery-my-suffix-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('GalleryMySuffix Management Dialog Component', () => {
        let comp: GalleryMySuffixDialogComponent;
        let fixture: ComponentFixture<GalleryMySuffixDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [GalleryMySuffixDialogComponent],
                providers: [
                    GalleryMySuffixService
                ]
            })
            .overrideTemplate(GalleryMySuffixDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(GalleryMySuffixDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new GalleryMySuffix(123);
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new GalleryMySuffix();
